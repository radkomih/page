  ...
  <Layout>
    ...
    <div className="container-fluid">
      <Section title="about" hideTitle={true}>
        ...
        <p>
          I have strong math and technical foundations. I thrive in scenarios where I have no prior knowledge or experience, as I am predominantly a self-taught and self-motivated individual.
        </p>
      ...
      <Experience
        ...
        projects={[
          ...
          "TinyGo-based Toolchain - Custom target and GC implementation"
        ]}
        responsibilities={[
          "Research",
        ...
        stack="Go, Rust, Solidity, Javascript, React Js, WebAssembly, Docker, Polkadot, Ethereum"
        >
        </Experience>
      ...
      <Section title="skills">
        ...
        <SkillSet
          ...
          subtitle="Rails, Sidekiq, Ember Js, React Js, Foundry Toolkit, Hardhat, Web3/Ethers Js"
        >
        </SkillSet>
      ...
      <Section title="interests">
        <SkillSet
          title="Open Source"
          subtitle="Contributing to privacy-preserving and decentralized tech projects and ecosystems"
        >
        </SkillSet>
      </Section>
    </div>
